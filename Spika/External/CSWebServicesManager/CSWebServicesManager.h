...
extern CSHTTPMethod const CSHTTPMethodGET;
extern CSHTTPMethod const CSHTTPMethodPOST;
extern CSHTTPMethod const CSHTTPMethodPUT;
extern CSHTTPMethod const CSHTTPMethodDELETE;
...
@property (nonatomic, readwrite)    AFHTTPClientParameterEncoding   parameterEncoding; ///Defult is AFFormURLParameterEncoding
@property (nonatomic, strong, readonly) CSURLCache              *urlCache; //Cache used for caching UIImages
...
/**
 ...
 @param mimeType mime type of the file being sent http://www.webmaster-toolkit.com/mime-types.shtml
 @param params The parameters to be encoded and set in the request HTTP body.
 @param resultBlock The block to be executed on the completion of a successful request. This block has no return value and takes one argument: the object constructed from the response data of the request.
 @param errorBlock The block to be executed on the completion of an unsuccessful request. This block has no return value and takes one argument: the error that occured during the request.
